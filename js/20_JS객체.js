...
btn2.addEventListener("click", ()=>{
  ...
  /* 
    ...
    1) 객체 내 햄수(메서드)에서 this == 같은 객체(여기, 이 객체)

    2) <button onclick="testFn(this)">테스트</button>
      여기서 this == 이벤트가 발생한 요소(클릭된 button)를 뜻한다

    3) 화살표 함수 내에서 this == window 객체
      (화살표 함수 내에서는 this를 못쓴다고 생각!!)
  */
...
function Student(inputGrade, inputBan, inputNumber, inputName){
  ...
  this.information = function(){
    let str = `${this.grade}학년 ${this.ban}반 ${this.number}번호 ${this.name}`;
