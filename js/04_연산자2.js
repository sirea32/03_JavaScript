...
function multipleCheck(){
  ...
  // 10은 5의 배수? ->  10을 5로 나눴을 때 나머지가 0인지 확인을 하면된다 0이면 배수
  // 5 곱하기 2가 10인건 초등학생 수준 위의 방법을 사용할것
...
function andCheck(){
  ...
  const bool1 = (104 >= 100) && (104 % 2 === 0); // (100 <= 104) // & 앰퍼센트 && 앤드
  ...
  // 수학배웠을때는 1<=13<=10 이렇게 배웠지만 프로그램 상에서는 요러면 안됨
