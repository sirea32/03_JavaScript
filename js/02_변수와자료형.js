...
function constCheck(){
  ...
  // 02_변수와자료형.js:102 -> 102번째 줄에서 오류 발생
...
function scopeTest2(){
  ...
  // 좁은 범위에서 넓은 범위로 출력가능하게 하는 명령어? 방법?

  // console.log("local1 : ", local1);
  // if문 지역변수 local1을
  // if문 밖에서 호출하면 "정의되지 않음" 오류발생 == if문 밖에서 사용하려고해서 오류가 남
...
function typeCheck(){
  ...
  console.log("ture  : ", true, typeof true);
